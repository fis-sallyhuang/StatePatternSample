...
{
    public class CMPSvcAction5<T> : ISvcAction<T> where T : class, ISvcInfo
    {
        ...
        public void getInfoFromApiResponse()
        {
            ...
            var fild3 = this.svcInfo.GetType().GetProperty("fild3");
            if(fild3 != null)
                fild3.SetValue(this.svcInfo, $" {this.GetType().Name} - fild3");
        }
    }
}
