...
{
    public class CMPSvcAction2<T> : ISvcAction<T> where T : class, ISvcInfo
    {
        ...
        public void getInfoFromApiResponse()
        {
            ...
            var fild1 = this.svcInfo.GetType().GetProperty("fild1");
            fild1.SetValue(this.svcInfo, $" {this.GetType().Name} - fild1");
        }
